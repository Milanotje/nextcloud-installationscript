...
nextcloud-installer() {
  bash <(curl -s https://raw.githubusercontent.com/Milanotje/nextcloud-installationscript/main/nextcloudinstaller.sh)
}

nextcloudlite-installer() {
  bash <(curl -s https://raw.githubusercontent.com/Milanotje/nextcloud-installationscript/main/nextcloudinstaller-lite02.sh)
}
...
while [ "$done" == false ]; do
  options=(
    ...
    "Install Nextcloud Lite With apache"
